        ...
        <div className="p-6">
          {step === 1 ? (
            <>
              ...
              {reward.expirationDays && (
                <div className="bg-[#111111] p-4 rounded-md mb-6">
                  <p className="text-sm text-gray-300">
                    ...
                    This reward must be used within {reward.expirationDays} days
                    after redemption.
                  </p>
                </div>
              )}
              ...
              {error && (
                <div className="bg-blood-red bg-opacity-20 text-blood-red p-4 rounded-md mb-6">
                  {error}
                </div>
              )}
