        ...
        >
          <Card className="flex flex-col h-full bg-otw-black-900 border-otw-gold-600/20 shadow-otw-md hover:border-otw-gold-600 transition-all">
            ...
            <div className="flex-1 flex flex-col p-4">
              <h3 className="font-bold text-lg text-otw-gold-600 mb-1">
                {item.name}
              </h3>
              <p className="text-gray-300 text-sm mb-2 flex-1">
                {item.description}
              </p>
              <div className="flex items-center justify-between mt-2">
                <span className="font-semibold text-xl text-otw-gold-500">
                  ${item.price.toFixed(2)}
                </span>
                <Button
                  size="sm"
                  variant="default"
                  className="bg-otw-gold-600 hover:bg-otw-gold-700 text-otw-black-950"
                >
                  Add to Cart
                </Button>
              </div>
