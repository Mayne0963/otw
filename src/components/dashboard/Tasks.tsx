...
const mockTasks: Task[] = [
  {
    id: '1',
    title: 'First Order',
    description: 'Place your first order with OTW',
    points: 100,
    type: 'achievement',
    icon: Trophy,
    completed: false,
  ...
  },
  {
    ...
    description: 'Invite friends to join OTW and earn rewards',
    points: 200,
    type: 'weekly',
    icon: Users,
    completed: false,
    progress: { current: 1, total: 3 },
    reward: '$5 credit for each referral'
  },
  {
    id: '5',
    title: 'Share on Social',
    description: 'Share your OTW experience on social media',
    points: 50,
    type: 'weekly',
    icon: Share2,
    completed: false,
  ...
  },
  {
    ...
    description: 'Complete 10 orders this month',
    points: 500,
    type: 'monthly',
    icon: Target,
    completed: false,
    progress: { current: 3, total: 10 },
    reward: 'Free delivery for next month'
  }
];
