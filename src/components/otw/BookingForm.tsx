  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
      <div className="space-y-4">
        <h2 className="text-2xl font-semibold text-otw-gold">Select a Service</h2>
        <RadioGroup
        ...
        >
          {services.map((service) => (
            <Card key={service.id} className="relative p-4 cursor-pointer hover:border-otw-gold transition-colors">
      ...
      <div className="space-y-4">
        <h2 className="text-2xl font-semibold text-otw-gold">Service Details</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <Input id="dropoff" placeholder="Enter dropoff address" className="mt-1" />
          </div>
        </div>

        <div>
          <Label htmlFor="instructions">Special Instructions</Label>
          <Textarea id="instructions" placeholder="Add any special instructions or requirements" className="mt-1" />
        </div>
      ...
      <Button type="submit" className="w-full bg-otw-red hover:bg-otw-gold hover:text-black transition-colors">
        Book Now
      </Button>
    </form>
  )
