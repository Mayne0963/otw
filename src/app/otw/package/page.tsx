      ...
      <section className="relative h-[40vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 z-10 text-center">
          ...
          <p className="text-xl text-gray-200 max-w-2xl mx-auto">
            Fast, reliable package delivery across Fort Wayne and surrounding
            areas.
          </p>
        </div>
      </section>
              ...
              <div className="bg-gray-800 p-4 rounded-lg mb-6">
                <div className="flex items-start">
                  ...
                  <p className="text-sm text-gray-300">
                    Delivery fees are calculated based on distance and package
                    size. You'll see the exact fee before confirming your
                    booking.
                  </p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-400">
                Need it there today? We offer same-day delivery for packages
                booked before 2 PM.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400">
                Your packages are treated with care. We ensure safe handling
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400">
                Track your package in real-time from pickup to delivery with our
                tracking system.
              </p>
            </div>
          </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
            ...
            <div className="bg-gray-900 rounded-lg p-6 border border-gray-800">
              ...
              <ul className="space-y-2 text-gray-300">
                <li className="flex items-center">
                  <svg
                    className="w-4 h-4 mr-2 text-otw-gold"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path
          ...
          <div className="mt-8 text-center text-gray-400">
            <p>
              Additional fee of $1.00 per mile applies for distances over 5
              miles.
            </p>
            <p>
              Same-day delivery fee: Additional $5.00 (orders placed before 2
              PM).
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="bg-gray-800 rounded-lg overflow-hidden shadow-lg border border-gray-700 p-8 text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              ...
              discounted delivery fees, priority scheduling, and free same-day
              delivery.
            </p>
            <Link href="/tier">
