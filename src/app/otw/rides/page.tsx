      ...
      <section className="relative h-[40vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 z-10 text-center">
          ...
          <p className="text-xl text-gray-200 max-w-2xl mx-auto">
            Safe, reliable transportation throughout Fort Wayne and surrounding
            areas.
          </p>
        </div>
      </section>
              ...
              <div className="bg-gray-800 p-4 rounded-lg mb-6">
                <div className="flex items-start">
                  ...
                  <p className="text-sm text-gray-300">
                    Your fare will be calculated based on distance and vehicle
                    type. You'll see the exact fare before confirming your
                    booking.
                  </p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-400">
                Our drivers are always on time. We value your schedule and
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400">
                No hidden fees or surge pricing. Know exactly what you'll pay
                before booking.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400">
                All our drivers are professionally trained, background-checked,
