              ...
              <div className="bg-gray-800 p-4 rounded-lg mb-6">
                <div className="flex items-start">
                  ...
                  <p className="text-sm text-gray-300">
                    You'll only pay the actual cost of groceries plus our
                    service fee. We'll provide a receipt with your delivery.
                  </p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-400">
                Tell us what you need, including brands and quantities.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400">
                Our shoppers carefully select your items with attention to
                quality and detail.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400">
                We'll contact you about any out-of-stock items and suggest
                alternatives.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400">
                We deliver your groceries right to your door at your scheduled
                time.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="bg-gray-900 rounded-lg p-6 border border-gray-800">
              ...
              <p className="text-gray-400 mb-4">
                Base fee for shopping and delivery
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="bg-gray-800 rounded-lg overflow-hidden shadow-lg border border-gray-700 p-8 text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              ...
              discounted service fees, free delivery, and priority scheduling.
            </p>
            <Link href="/tier">
