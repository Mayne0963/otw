...
export default function InfusedMenuPage() {
  ...
  const categories = [
    { id: "all", name: "All" },
    ...Array.from(new Set(infusedMenuItems.map((item) => item.category))).map(
      (category) => ({
        id: category,
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div
        className={`${showComingSoon ? "blur-sm" : ""} transition-all duration-300`}
      >
        {/* Hero Section */}
        <section className="relative h-[50vh] min-h-[400px]">
          ...
          <div className="relative z-10 container mx-auto px-4 h-full flex flex-col justify-center items-center text-center">
            ...
            <p className="text-xl text-gray-200 max-w-2xl">
              Explore our premium infused culinary creations, crafted for an
              elevated experience.
            </p>
          </div>
        </section>
