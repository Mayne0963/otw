...
export const metadata: Metadata = {
  ...
  description: "Join our community of volunteers and make a difference in Fort Wayne.",
}
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-otw-gold mb-4">Join Our Volunteer Community</h1>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Help us make Fort Wayne a better place. Join our network of dedicated volunteers and earn rewards while
            making a difference.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div className="bg-gray-900 rounded-lg p-8">
            <h2 className="text-2xl font-bold text-otw-gold mb-6">Become a Volunteer</h2>
            <VolunteerSignup />
          </div>

          <div className="space-y-6">
            <Card className="p-6">
              <h2 className="text-2xl font-bold text-otw-gold mb-4">Volunteer Impact</h2>
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-otw-gold">Volunteer Stories</h2>
              <VolunteerFeed />
            </div>
          </div>
        </div>
