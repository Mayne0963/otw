      ...
      <section className="relative h-[50vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 z-10 text-center">
          ...
          <p className="text-xl text-gray-200 max-w-2xl mx-auto">
            Make a difference in your community while gaining valuable
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              At Broski&apos;s Kitchen, we believe in giving back to our
              community. Our volunteer program provides opportunities for
              individuals to contribute their time and talents while gaining
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div>
                ...
                <p className="text-gray-400">
                  Help us serve those in need and strengthen our local
                  community.
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-400">
                  Gain hands-on experience and learn from industry
                  professionals.
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-400">
                  Build relationships with like-minded individuals who share
                  your passion.
                </p>
              </div>
            </div>
            ...
            <div className="animate-fade-in">
              <div className="max-w-3xl mx-auto text-center mb-12">
                ...
                <p className="text-gray-300 text-lg">
                  We offer a variety of volunteer positions to match your skills
                  and interests. All volunteers receive training and support
          ...
          {activeTab === "requirements" && (
            <div className="animate-fade-in">
              <div className="max-w-3xl mx-auto text-center mb-12">
                ...
                <p className="text-gray-300 text-lg">
                  We welcome volunteers from all backgrounds. Here are some
                  general requirements for joining our volunteer team.
                </p>
              </div>
                ...
                <ol className="space-y-4">
                  ...
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">
                        Selected applicants will be invited for a brief
                        interview to discuss their interests and availability.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">
                        Attend a volunteer orientation session to learn about
                        our mission, policies, and procedures.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">
                        Receive role-specific training from our staff to prepare
                        you for your volunteer position.
                      </p>
                    </div>
                  </li>
                </ol>
          ...
          {activeTab === "benefits" && (
            <div className="animate-fade-in">
              <div className="max-w-3xl mx-auto text-center mb-12">
                ...
                <p className="text-gray-300 text-lg">
                  Volunteering at Broski&apos;s Kitchen offers numerous benefits
                  beyond the satisfaction of giving back to your community.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                <div className="bg-[#1A1A1A] rounded-lg p-6 border border-[#333333]">
                  ...
                  <p className="text-gray-400 mb-4">
                    Gain hands-on experience in a professional kitchen
                    environment and learn from our skilled chefs.
                  </p>
                ...
                <div className="bg-[#1A1A1A] rounded-lg p-6 border border-[#333333]">
                  ...
                  <p className="text-gray-400 mb-4">
                    Build your resume and develop transferable skills that can
                    benefit your career.
                  </p>
                  <ul className="space-y-2">
                    <li className="flex items-start">
                ...
                <div className="bg-[#1A1A1A] rounded-lg p-6 border border-[#333333]">
                  ...
                  <p className="text-gray-400 mb-4">
                    Build meaningful relationships and connect with your
                ...
                <div className="bg-[#1A1A1A] rounded-lg p-6 border border-[#333333]">
                  ...
                  <p className="text-gray-400 mb-4">
                    Enjoy special benefits as a thank you for your dedication
                    and service.
                  </p>
                  <ul className="space-y-2">
                    <li className="flex items-start">
          ...
          {activeTab === "testimonials" && (
            <div className="animate-fade-in">
              <div className="max-w-3xl mx-auto text-center mb-12">
                ...
                <p className="text-gray-300 text-lg">
                  Hear from our current and past volunteers about their
                  experiences at Broski&apos;s Kitchen.
                </p>
              </div>
          ...
          {activeTab === "faq" && (
            <div className="animate-fade-in">
              <div className="max-w-3xl mx-auto text-center mb-12">
                ...
                <p className="text-gray-300 text-lg">
                  Find answers to common questions about volunteering at
                  Broski&apos;s Kitchen.
                </p>
              </div>
                ...
                {volunteerFAQs.map((faq, index) => (
                  ...
                  >
                    <h3 className="text-lg font-bold mb-2 flex items-center">
                      <FaQuestionCircle className="text-gold-foil mr-2 flex-shrink-0" />{" "}
                      {faq.question}
                    </h3>
              ...
              <div className="max-w-3xl mx-auto mt-12 text-center">
                <p className="text-gray-300 mb-6">
                  Don&apos;t see your question? Contact our volunteer
      ...
      <section className="py-16 bg-black relative">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
            Join our volunteer team and help us make a positive impact in our
            community while gaining valuable experience.
          </p>
          <button onClick={() => setShowForm(true)} className="btn-primary">
            Apply to Volunteer
          </button>
