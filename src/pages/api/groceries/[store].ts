...
const sampleGroceries: Record<string, any> = {
  walmart: {
    store: 'Walmart',
    items: [
      { id: 'g1', name: 'Milk', price: 2.99, description: '1 gallon whole milk.' },
      { id: 'g2', name: 'Eggs', price: 1.99, description: 'Dozen large eggs.' },
      { id: 'g3', name: 'Bread', price: 2.49, description: 'Whole wheat bread.' },
    ],
  },
  kroger: {
    store: 'Kroger',
    items: [
      ...
      { id: 'g2', name: 'Chicken Breast', price: 4.99, description: 'Boneless, skinless.' },
